<?php 
class Controller_Admin_Usergoodlike extends Controller_Admin_Abstract {

	private $_model;

	public function __construct() {
		parent::__construct();
		$this->_model = Model_Admin_Usergoodlike::getInstance();
	}
	...
	public function listAction() {
		...
		$this->_tpl->display('admin/user_good_like.php');
	}
}
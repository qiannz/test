...
<div id="rightTop">
  <p>用户管理</p>
  <ul class="subnav">
    <li><a class="btn4" href="/admin/usergoodcollect/list/uid:{{$request.uid}}/uname:{{$request.uname}}">用户商品收藏</a></li>
  </ul>
</div>
<div class="mrightTop">
  <div class="fontl">
    <form method="post" action="{{$_CONF.FORM_ACTION}}">
      ...
      <a class="left formbtn1" href="/admin/usergoodcollect/list/{{$page_str}}">撤销检索</a>
    </form>
  </div>

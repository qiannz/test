...
function checkUser()
{
	...
	$.post('/admin/spike/check-user-shop', {user_name:user_name}, function(data){
		if (data == 'ok') {
			$('#ts').html('此用户不是店铺营业员');
			$("#table").remove();
			return false;
...
<div id="rightTop">
  <p>券管理</p>
  <ul class="subnav">
    <li><a class="btn4" href="/admin/spike/list">快来抢</a></li>
...
<div class="mrightTop">
  <div class="fontl">
    <form method="post" action="{{$_CONF.FORM_ACTION}}" id="form">
      ...
      <a class="left formbtn1" href="/admin/spike/user-shop">撤销检索</a> &nbsp;&nbsp;&nbsp;
...
<div class="tdare">
  ...
  <table width="100%" cellspacing="0" class="dataTable" id="table">
    ...
    <tr class="tatr2">
      ...
      <td><a href="/admin/spike/add-edit/sid:{{$item.shop_id}}/uname:{{$user_name}}">添加快来抢</a></td>
    </tr>
   {{foreachelse}}
    <tr class="no_data">

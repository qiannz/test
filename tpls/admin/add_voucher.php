...
<div id="rightTop">
  <p>券管理</p>
  <ul class="subnav">
    <li><a class="btn1" href="/admin/ticket/voucher-list/page:{{$page}}">现金券列表</a></li>
    {{if !$row.ticket_id}}<li><a class="btn3" href="/admin/ticket/user-shop/type:v/uname:{{$uname}}">店铺选择列表</a></li>{{/if}}
    <li><span>{{if $row.ticket_id}}编辑现金券{{else}}新建现金券{{/if}}</span></li>
  </ul>
</div>
	...
	<div id="tabs-1">
        <table class="infoTable">
            ...
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                  <input class="infoTableInput2" type="text" name="par_value" id="par_value" value="{{$row.par_value}}" />
                  <label class="field_notice"></label>
                </td>
            </tr>
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                  <input class="infoTableInput2" type="text" name="selling_price" id="selling_price" value="{{$row.selling_price}}" />
                  <label class="field_notice"></label>
                </td>
            </tr>
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                  <input class="infoTableInput2" type="text" name="app_price" id="app_price" value="{{if $row.app_price gt 0}}{{$row.app_price}}{{/if}}" />
            ...
            <tr>
                ...
                <td class="paddingT15 wordSpacing5" >
                    <input type="radio" name="can_share" value="0" {{if $row.can_share|_isset && $row.can_share eq 0}}checked="checked"{{else}}checked="checked"{{/if}} />否
                    <input type="radio" name="can_share" value="1" {{if $row.can_share|_isset && $row.can_share eq 1}}checked="checked"{{/if}} />是
                    <label class="field_notice"></label>
                </td>
            </tr>
        </table>

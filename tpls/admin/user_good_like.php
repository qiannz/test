...
<div id="rightTop">
  <p>用户管理</p>
  <ul class="subnav">
    <li><a class="btn4" href="/admin/usergoodlike/list/uid:{{$request.uid}}/uname:{{$request.uname}}">用户商品喜欢</a></li>
  </ul>
</div>
<div class="mrightTop">
  <div class="fontl">
    <form method="post" action="{{$_CONF.FORM_ACTION}}">
      ...
      <a class="left formbtn1" href="/admin/usergoodlike/list/{{$page_str}}">撤销检索</a>
    </form>
  </div>

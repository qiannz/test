...
<div id="rightTop">
  <p>用户管理</p>
  <ul class="subnav">
    <li><a class="btn1" href="/admin/discount/list/page:{{$page}}">折扣管理</a></li>
    <li><span>推荐</span></li>
    <li><span>{{$discountRow.title}}</span></li>
  </ul>
</div>
<div class="info">
 <form method="post" id="recommend" enctype="multipart/form-data" >
  <input type="hidden" name="did" id="did" value="{{$discountRow.discount_id}}" />

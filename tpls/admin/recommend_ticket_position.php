...
<div id="rightTop">
  ...
  <ul class="subnav">
    <li>
    	{{if $mark eq 'coupon'}}
    	<a class="btn4" href="/admin/ticket/coupon-list/page:{{$page}}">优惠券列表</a>
        {{elseif $mark eq 'voucher'}}
        <a class="btn4" href="/admin/ticket/voucher-list/page:{{$page}}">代金券列表</a>
        {{/if}}
    </li>
    <li><span>推荐</span></li>
    <li><span>{{$ticketRow.ticket_title}}</span></li>
  </ul>
</div>
<div class="info">

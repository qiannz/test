...
<div class="tdare" style="min-width:1428px;">
  ...
  <table width="100%" cellspacing="0" class="dataTable">
    ...
    <tr class="tatr2">
      ...
      <td>
      		<a href="/admin/ticket/add-voucher/tid:{{$item.ticket_id}}/uname:{{$item.user_name}}/sid:{{$item.shop_id}}/page:{{$page}}">编辑</a> | 
            {{if $item.ticket_status eq '1' && $item.apply_status neq '-1'}}
            <a href="/admin/ticket/recommend/id:{{$item.ticket_id}}/type:{{$item.ticket_type}}/page:{{$page}}">推荐</a> | 
            {{/if}}

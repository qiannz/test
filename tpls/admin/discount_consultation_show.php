...
<div id="rightTop">
  ...
  <ul class="subnav">
    ...
    <li><a class="btn1" href="/admin/discount/consultation/did:{{$did}}">咨询管理</a></li>
    <li><span>咨询明细</span></li>
  </ul>
</div>
...
<div class="tdare">
  ...
  <table width="100%" cellspacing="0" class="dataTable">
    ...
    <tr class="tatr2">
      ...
      <td width="200">{{if $item.first eq 0}}<a href="javascript:drop_confirm('确定删除', '/admin/discount/del-consultation-post/did:{{$did}}/tid:{{$item.tid}}/pid:{{$item.pid}}')">删除</a>{{/if}}</td>
    </tr>
    {{/foreach}}
  </table>
</div>

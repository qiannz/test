...
<div id="rightTop">
  <p>券管理</p>
  <ul class="subnav">
    <li><a class="btn1" href="/admin/spike/list/page:{{$page}}">快来抢</a></li>
    {{if !$row.ticket_id}}<li><a class="btn3" href="/admin/spike/user-shop/uname:{{$uname}}">店铺选择</a></li>{{/if}}
    <li><span>{{if $row.ticket_id}}编辑快来抢{{else}}新建快来抢{{/if}}</span></li>
  </ul>
</div>
<div class="info">
	...
	<div id="tabs-1">
        <table class="infoTable">
            ...
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                  <input class="infoTableFile2" style="width:140px;" type="text" name="sdate" id="sdate" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="{{if $row.start_time}}{{$row.start_time|date_format:'%Y-%m-%d %H:%M:%S'}}{{/if}}" /> - 

                  <input class="infoTableFile2" style="width:140px;" type="text" name="edate" id="edate" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="{{if $row.end_time}}{{$row.end_time|date_format:'%Y-%m-%d %H:%M:%S'}}{{/if}}"/>
                  <label class="field_notice"></label>
                </td>
            </tr>
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                  <input class="infoTableFile2" style="width:140px;" type="text" name="stime" id="stime" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="{{if $row.valid_stime}}{{$row.valid_stime|date_format:'%Y-%m-%d %H:%M:%S'}}{{/if}}" /> - 
                  <input class="infoTableFile2" style="width:140px;" type="text" name="etime" id="etime" onFocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="{{if $row.valid_etime}}{{$row.valid_etime|date_format:'%Y-%m-%d %H:%M:%S'}}{{/if}}"/>
                  <label class="field_notice"></label>
                </td>
            </tr> 
            <tr>

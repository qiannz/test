...
<div id="rightTop">
  <p>券管理</p>
  <ul class="subnav">
    <li><a class="btn4" href="/admin/crowdfunding/list/page:{{$page}}">一元众筹</a></li>
    <li><span>审核一元众筹</span></li>
  </ul>
</div>
...
<iframe width=100% height=600 frameborder=0 scrolling=auto src="/home/ticket/wap/tid/{{$tid}}"></iframe>
</table>
</div>

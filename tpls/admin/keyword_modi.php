        ...
        <table class="infoTable">
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableInput2" id="keywrod" type="text" name="keyword" value="{{$keyword.keyword_name}}" />
            ...
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableInput2" style='width:30px;'id="keyword_searches" type="text" name="keyword_searches" value="{{$keyword.keyword_searches}}" />
                    <label class="field_notice"></label>
                </td>
            </tr>
            <tr>

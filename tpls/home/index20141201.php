...
<body>
    	...
    	<div class="focus-pic">
        	<ul style="width:999999px" id="focus-list">
            	{{foreach from=$imgLargeList key=key item=item}}
                	<li><a href="{{$item.www_url}}" target="_blank"><img width="1200" height="300" src="/images/blank.png"  data-lazyload="{{$item.img_url}}"></a></li>
                {{/foreach}}
            </ul>
    ...
    <div class="hotShop">
        ...
        <ul>
            ...
            <li>
                <p class="{{if $key mod 2 eq 1}}brand{{else}}brand-on{{/if}}"><a target="_blank" href="{{$item.www_url}}">{{$item.title}}</a></p>
                <p class="shopName"><a target="_blank" href="{{$item.www_url}}">{{$item.summary}}</a></p>
            </li>
            {{/foreach}}
    ...
    <div class="content-list">
          ...
          <div class="left-list">
          	<ul>
                ...
                {{foreach from=$brandStore key=key item=item}}
                	
                	<li><a href="/home/brand/list#{{$key}}" id="left-list-btn_{{counter}}">{{$item}}</a></li>
                {{/foreach}}
          ...
          <div class="small-focus">
          		<ul class="small-focus-list" style="width:999999px" id="small-focus-list_01">
          			{{foreach from=$indexBrandList key=key item=item}}
                		<li><a href="{{if $item.come_from_id neq 0}}/home/brand/show/bid/{{$item.come_from_id}}{{else}}{{$item.www_url}}{{/if}}"  target="_blank"><img width="640" height="300" src="/images/blank.png"  data-lazyload="{{$item.img_url}}"></a></li>
                    {{/foreach}} 
                </ul>
          ...
          <div class="right-list" id="right-list_01">
          	<ul>
          		{{foreach from=$indexBrandLogoList key=key item=item}}
            	<li><a href="{{if $item.come_from_id neq 0}}/home/brand/show/bid/{{$item.come_from_id}}{{else}}{{$item.www_url}}{{/if}}" target="_blank"><img width="110" height="73"  src="/images/blank.png"  data-lazyload="{{$item.img_url}}"></a></li>
                {{/foreach}}
            </ul>
    ...
    <div class="content-list">
          ...
          <div class="left-list_02">
          	...
          	{{foreach from=$region key=key item=item}}
            	<li><a href="/home/market/list#{{$key}}" >{{$item}}</a></li>
			{{/foreach}}
            </ul>    
          </div>
          <!--small focus-->
          <div class="small-focus">
          		...
          		{{foreach from=$indexMarketList key=key item=item}}
                	<li><a href="{{if $item.come_from_id neq 0}}/home/market/show/mid/{{$item.come_from_id}}{{else}}{{$item.www_url}}{{/if}}" target="_blank"><img width="640" height="300" src="/images/blank.png"  data-lazyload="{{$item.img_url}}"></a></li>
				{{/foreach}}
                </ul>
          ...
          <div class="right-list" id="right-list_02">
          	<ul>
          		{{foreach from=$indexMarketLogoList key=key item=item}}
            	<li><a href="{{if $item.come_from_id neq 0}}/home/market/show/mid/{{$item.come_from_id}}{{else}}{{$item.www_url}}{{/if}}"  target="_blank"><img width="110" height="73"  src="/images/blank.png"  data-lazyload="{{$item.img_url}}"></a></li>
            	{{/foreach}}
            </ul>
            <span class="hover-link"></span>
          </div>
  ...
  <div class="picList">
      ...
      <ul>
     	 ...
     	 {{if $item.come_from_type eq 1}}
            ...
            <div class="pic">
                ...
                <a href="{{$item.www_url}}" target="_blank"><img width="220" height="300" src="/images/blank.png"  data-lazyload="{{$item.img_url}}"></a>
             </div>
            <div class="txt">
                <p class="l1"><span class="name"><a href="/home/shop/show/sid/{{$item.shop_id}}" target="_blank">{{$item.shop_name}}</a></span><span class="price">¥<font>{{$item.dis_price}}</font></span></p>
   ...
   {{foreach from=$recommendClassificationGoodList key=key item=item}}
    <div class="picList">
     <h2 class="title titleLine">{{$item.pos_name}}</h2>
     {{if $item.child}}
      <ul>
	      ...
	      {{if $sitem.come_from_type eq 1}}
	       	<li>
	            <div class="pic">
	                <a href="{{$sitem.www_url}}" target="_blank"><img width="220" height="300" src="/images/blank.png"  data-lazyload="{{$sitem.img_url}}"></a>
	             </div>
	            <div class="txt">
	                <p class="l1"><span class="name"><a href="/home/shop/show/sid/{{$sitem.shop_id}}" target="_blank">{{$sitem.shop_name}}</a></span><span class="price">¥<font>{{$sitem.dis_price}}</font></span></p>

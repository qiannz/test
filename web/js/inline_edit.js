...
$('span[ectype="inline_edit"]').click(function(){
    ...
    $('<input type="text">').css({border:'1px solid #ccc',width:'100px',height:'20px'})
                        ...
                        if(event.keyCode == 13)
                        {
                            ...
                            $.post('/admin/'+app+'/ajax-col',{id:s_id,column:s_name,value:value,'ajax':1},function(data){
                                if(data === 'false')
                                {
                                    alert('此名称已存在，请您更换一个');
...
$('img[ectype="inline_edit"]').click(function(){
                ...
                $.post('/admin/'+app+'/ajax-col',{id:i_id,column:i_name,value:i_val},function(data){
                if(data === 'true')
                    {

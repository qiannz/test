...
KindEditor.plugin('emoticons', function (K) {
    ...
    self.clickToolbar(name, function () {
        ...
        initImgBox(faceBox['tab0'], 'm_00', 32);
        initImgBox(faceBox['tab1'], 'QQ_00', 26);
        initImgBox(faceBox['tab2'], 'al_00', 32);
        initImgBox(faceBox['tab3'], 'mg_00', 32);
        initImgBox(faceBox['tab4'], 'mp_00', 12);
        inforBox['tab0'] = [];
        inforBox['tab1'] = [];
        inforBox['tab2'] = [];
		inforBox['tab3'] = [];
        ...
        //大对象
        FaceHandler = {
            imageFolders: { tab0: 'default/', tab1: 'kebai/', tab2: 'ali/', tab3: 'mogu/', tab4: 'mpzhuanshu/' },
            ...
            imageCss: { tab0: 'jd', tab1: 'tsj', tab2: 'ldw', tab3: 'bb', tab4: 'cat' },
            imageCssOffset: { tab0: 35, tab1: 35, tab2: 35, tab3: 35, tab4: 35},
            tabExist: [0, 0, 0, 0, 0]
        };

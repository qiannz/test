<?php /* Smarty version 2.6.27, created on 2016-02-04 18:06:57
         compiled from admin/buygood_list.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/buygood_list.php', 102, false),)), $this); ?>
...
">
       <div class="left">
			...
			<select name="app" class="querySelect">
                ...
                <option value="2" <?php if ($this->_tpl_vars['request']['app'] == 2): ?>selected="selected"<?php endif; ?>>进行中</option>
            ...
            显示状态：
             <select name="iss" class="querySelect">
            	<option value="">全部</option>
                <option value="1" <?php if ($this->_tpl_vars['request']['iss'] == 1): ?>selected="selected"<?php endif; ?>>显示</option>
                <option value="2" <?php if ($this->_tpl_vars['request']['iss'] == 2): ?>selected="selected"<?php endif; ?>>不显示</option>
            </select>
            团购名称：
...
<?php endif; ?></td>
      ...
      <td><?php echo $this->_tpl_vars['item']['par_value']; ?>
</td>
...
<?php endif; ?></td>
      <td>
			...
			<?php elseif ($this->_tpl_vars['item']['apply_status'] == '1'): ?>进行中
            <?php endif; ?>
      </td>
      <td>
...
<?php endif; ?></td>
      <td>
      		<a href="/admin/buygood/add-edit/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
...
">编辑</a> | 
            ...
            <a href="/admin/buygood/recommend/id:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
...
">推荐</a> | 
            ...
            <a href="/admin/buygood/audit/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
/page:<?php echo $this->_tpl_vars['page']; ?>
">审核</a> |<?php endif; ?>

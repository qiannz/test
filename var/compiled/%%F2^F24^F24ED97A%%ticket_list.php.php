<?php /* Smarty version 2.6.27, created on 2016-02-03 10:28:10
         compiled from admin/ticket_list.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/ticket_list.php', 84, false),)), $this); ?>
...
?>
    <tr class="tatr2">
      <td><?php if ($this->_tpl_vars['item']['ticket_uuid']): ?>【<?php echo $this->_tpl_vars['item']['ticket_uuid']; ?>
】<?php endif; ?></td>
 ...
 / <?php echo $this->_tpl_vars['item']['has_led']; ?>
 / <?php echo $this->_tpl_vars['item']['used']; ?>
</td>
      <td>
...
<?php endif; ?></td>
      <td>
      		<a href="/admin/ticket/add-coupon/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
...
">推荐</a> | 
            ...
            <a href="/admin/ticket/audit/title:<?php echo $this->_tpl_vars['item']['ticket_title']; ?>
/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
/type:<?php echo $this->_tpl_vars['item']['ticket_type']; ?>
/page:<?php echo $this->_tpl_vars['page']; ?>
">审核</a> |<?php endif; ?>
            <a href="/admin/ticket/export/title:<?php echo $this->_tpl_vars['item']['ticket_title']; ?>

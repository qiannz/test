<?php /* Smarty version 2.6.27, created on 2016-12-01 16:30:36
         compiled from admin/historylog_list.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/historylog_list.php', 41, false),array('modifier', 'date_format', 'admin/historylog_list.php', 80, false),)), $this); ?>
...
?>
            	<option value="<?php echo $this->_tpl_vars['item']['pmodule']; ?>
" <?php if ($_REQUEST['pmodule'] == $this->_tpl_vars['item']['pmodule']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['pmodule']; ?>
</option>
    ...
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
            	<option value="<?php echo $this->_tpl_vars['item']['cmodule']; ?>
" <?php if ($_REQUEST['cmodule'] == $this->_tpl_vars['item']['cmodule']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['cmodule']; ?>
</option>
            	<?php endforeach; endif; unset($_from); ?>
        	</select> &nbsp;&nbsp;&nbsp;
        	操作动作：
			...
			<select class="querySelect" name="field_name">
            	<?php $_from = $this->_tpl_vars['query_fields']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
            	<option value="<?php echo $this->_tpl_vars['key']; ?>
" <?php if ($_REQUEST['field_name'] == $this->_tpl_vars['key'] || $this->_tpl_vars['key'] == $this->_tpl_vars['type']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']; ?>
</option>
            	<?php endforeach; endif; unset($_from); ?>
			</select>  

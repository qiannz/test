<?php /* Smarty version 2.6.27, created on 2016-02-15 15:11:34
         compiled from admin/special_list.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/special_list.php', 51, false),)), $this); ?>
...
?>
    <tr class="tatr2">
      <td class="firstCell"><input type="checkbox" class="checkitem" value="<?php echo $this->_tpl_vars['item']['special_id']; ?>
" /></td>
      <td><?php echo $this->_tpl_vars['item']['special_id']; ?>
</td>
...
<?php endif; ?></td>
      <?php if ($this->_tpl_vars['request']['isd'] == 0): ?>
      <td>
      		<a href="/admin/special/add-edit/sid:<?php echo $this->_tpl_vars['item']['special_id']; ?>
">编辑</a> | 
      		<a href="javascript:drop_confirm('del', <?php echo $this->_tpl_vars['item']['special_id']; ?>
)">删除</a> |
            <a href="/admin/special/recommend/sid:<?php echo $this->_tpl_vars['item']['special_id']; ?>
">推荐</a> |
            <a href="/admin/discount/group-chat/did:<?php echo $this->_tpl_vars['item']['special_id']; ?>
/page:<?php echo $this->_tpl_vars['page']; ?>
/type:special">群聊</a> |
            <a href="javascript:jumpToLog('special', '<?php echo $this->_tpl_vars['item']['special_id']; ?>
')">记录</a> 
      </td>
      <?php endif; ?>
    </tr>
   <?php endforeach; else: ?>
    <tr class="no_data">
      <td colspan="<?php if ($this->_tpl_vars['request']['isd'] == 0): ?>5<?php else: ?>4<?php endif; ?>">暂无数据</td>
    </tr>

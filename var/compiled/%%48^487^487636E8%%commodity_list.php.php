<?php /* Smarty version 2.6.27, created on 2016-02-18 17:45:50
         compiled from admin/commodity_list.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/commodity_list.php', 84, false),)), $this); ?>
...
<?php endif; ?></td>
      <td>
      		<a href="/admin/commodity/add-edit/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
/type:2/sid:<?php echo $this->_tpl_vars['item']['shop_id']; ?>
/uname:<?php echo $this->_tpl_vars['item']['user_name']; ?>
/page:<?php echo $this->_tpl_vars['page']; ?>
">编辑</a> | 
            <?php if ($this->_tpl_vars['item']['ticket_status'] == '1'): ?>
            <a href="/admin/commodity/recommend/id:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
...
">推荐</a> | 
            ...
            <a href="/admin/commodity/audit/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>

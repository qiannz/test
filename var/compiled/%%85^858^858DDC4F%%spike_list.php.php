<?php /* Smarty version 2.6.27, created on 2016-02-17 14:22:49
         compiled from admin/spike_list.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/spike_list.php', 85, false),)), $this); ?>
...
<div id="rightTop">
  ...
  <ul class="subnav">
    <li><span>快来抢</span></li>
    <li><a class="btn4" href="/admin/spike/user-shop">新增快来抢</a></li>
  </ul>
</div>
...
" />
      ...
      <a class="left formbtn1" href="/admin/spike/list">撤销检索</a>
    </form>
  </div>
...
<?php endif; ?></td>
      <td>
      		<a href="/admin/spike/add-edit/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
...
">编辑</a> | 
            ...
            <a href="/admin/spike/recommend/id:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
/type:<?php echo $this->_tpl_vars['item']['ticket_type']; ?>
/page:<?php echo $this->_tpl_vars['page']; ?>
">推荐</a> | 
            <?php endif; ?>
            <?php if ($this->_tpl_vars['item']['ticket_status'] == 0): ?>
            <a href="/admin/spike/audit/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>
/sid:<?php echo $this->_tpl_vars['item']['shop_id']; ?>
/page:<?php echo $this->_tpl_vars['page']; ?>
">审核</a> |
            <?php endif; ?>

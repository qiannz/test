<?php /* Smarty version 2.6.27, created on 2016-12-01 16:30:02
         compiled from admin/voucher_list.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/voucher_list.php', 104, false),)), $this); ?>
...
<div id="rightTop">
  <p>券管理</p>
  <ul class="subnav">
    <li><span>现金券列表</span></li>
    <li><a class="btn4" href="/admin/ticket/user-shop/type:v">新增现金券</a></li>
  </ul>
</div>
...
" />
      ...
      <a class="left formbtn1" href="/admin/ticket/voucher-list">撤销检索</a>
    </form>
  </div>
...
<?php endif; ?></td>
      <td>
      		<a href="/admin/ticket/add-voucher/tid:<?php echo $this->_tpl_vars['item']['ticket_id']; ?>

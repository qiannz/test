<?php /* Smarty version 2.6.27, created on 2016-02-15 15:11:36
         compiled from admin/special_add.php */ ?>
...
<div id="rightTop">
	<p>用户管理</p>
	<ul class="subnav">
		<li><a class="btn4" href="/admin/special/list/page:<?php echo $this->_tpl_vars['page']; ?>
">专题管理</a></li>
		<li><span><?php if ($this->_tpl_vars['row']['special_id']): ?>编辑专题<?php else: ?>新建专题<?php endif; ?></span></li>
	</ul>
</div>
<div class="info">
	<form method="POST" enctype="multipart/form-data" action="<?php echo $this->_tpl_vars['_CONF']['FORM_ACTION']; ?>
" id="form">
	    <input type="hidden" name="sid" id="sid" value="<?php echo $this->_tpl_vars['row']['special_id']; ?>
" />
...
" />
		<table class="infoTable">
			        <tr>
			            ...
			            <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" type="text" name="title" id="title" value="<?php echo $this->_tpl_vars['row']['title']; ?>
"style="width: 300px;" /> 
			        ...
			        <tr>
			            ...
			            <td class="paddingT15 wordSpacing5">
			            	<input class="file" type="file" name="cover_img" id="cover_img" value="<?php echo $this->_tpl_vars['row']['cover_img']; ?>
" style="width: 400px;" /> 
		            ...
		            <tr>
		                ...
		                <td class="paddingT15 wordSpacing5">
		                  <img id="coverImg" src="<?php echo $this->_tpl_vars['_CONF']['IMG_URL']; ?>
			        ...
			        <tr>
			            ...
			            <td class="paddingT15 wordSpacing5">
			               <span id="choiceBoxBrand" class="choiceBox">
					           <?php $_from = $this->_tpl_vars['goodArray']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
					           <a data-id="<?php echo $this->_tpl_vars['item']['id']; ?>
"><span><?php echo $this->_tpl_vars['item']['name']; ?>
</span><img class="brandDel" src="/images/delete.png" data-gid = "<?php echo $this->_tpl_vars['item']['id']; ?>
"/></a>
			        ...
			        <tr>
			            <th class="paddingT15"></th>
			            <td class="ptb20"><?php if ($this->_tpl_vars['row']['special_id']): ?> <input type="button" value="编辑"
			                name="Submit" class="formbtn1" onClick="checkSubmit()"> <input
			                type="reset" value="重置" name="reset" class="formbtn2"> <?php else: ?> <input
			                type="button" value="提交" name="Submit" class="formbtn1"
			                onClick="checkSubmit()"> <?php endif; ?>
			            </td>
			        </tr>      
		</table>
	</form>

...
class Third_RedisCluster {
     ...
     * @access private
     */
    private $dont_hash = array('RANDOMKEY', 'DBSIZE', 'SELECT', 'MOVE', 'FLUSHDB', 'FLUSHALL', 'SAVE', 'BGSAVE', 'LASTSAVE', 'SHUTDOWN', 'INFO', 'MONITOR', 'SLAVEOF');
    ...
    public function __construct($servers){
        ...
        foreach($servers as $alias=>$server){
            ...
            $redisObj->connect($server['host'], $server['port']);
            $this->redisents[] = $redisObj;

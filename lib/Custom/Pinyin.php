...
class Custom_Pinyin {
    ...
    private static function _getData(){
        ...
        'fu'=>'-18446', 'fou'=>'-18447', 'fo'=>'-18448', 'feng'=>'-18463', 'fen'=>'-18478', 'fei'=>'-18490', 'fang'=>'-18501', 'fan'=>'-18518', 'fa'=>'-18526', 'er'=>'-18696', 
    ...
    private static function _single($str){
        ...
        for($i = 0; $i < strlen($str); $i++){
            ...
            ($ascii > 160) && $ascii = $ascii * 256 + ord(substr($str, ++$i, 1)) - 65536;
